...
const local = StyleSheet.create({
  categoryAmount: {color: C.pine, fontFamily: F.b, fontSize: 10, minWidth: 74, textAlign: 'right'},
  categoryCount: {color: C.muted, fontFamily: F.r, fontSize: 8},
  categoryLabel: {color: C.pine, flex: 1, fontFamily: F.m, fontSize: 10},
  ...
  categoryShare: {color: C.muted, fontFamily: F.s, fontSize: 9, minWidth: 36, textAlign: 'right'},
  ...
  ocrNote: {backgroundColor: C.purpleSoft, borderRadius: 10, color: '#4d568c', fontFamily: F.m, fontSize: 9, lineHeight: 14, marginTop: 9, padding: 9},
  scanIcon: {alignItems: 'center', borderRadius: 13, height: 38, justifyContent: 'center', width: 38},
  scanMeta: {color: C.muted, fontFamily: F.r, fontSize: 8, marginTop: 2},
  ...
  scanTitle: {color: C.pine, fontFamily: F.s, fontSize: 10},
  txAmount: {fontFamily: F.b, fontSize: 11},
  txIcon: {alignItems: 'center', borderRadius: 13, height: 38, justifyContent: 'center', width: 38},
  txMeta: {color: C.muted, fontFamily: F.r, fontSize: 8, marginTop: 2},
  txRow: {alignItems: 'flex-start', backgroundColor: '#f5f8f2', borderRadius: 13, flexDirection: 'row', gap: 10, marginTop: 9, padding: 11},
  txTitle: {color: C.pine, fontFamily: F.s, fontSize: 10},
  warnNotice: {backgroundColor: C.amberSoft, borderRadius: 10, color: '#8a6b28', fontFamily: F.m, fontSize: 9, marginTop: 12, padding: 9},
});
