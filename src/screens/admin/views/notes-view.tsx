...
const local = StyleSheet.create({
  ...
  breakdownCount: {color: C.pine, fontFamily: F.b, fontSize: 11, minWidth: 30, textAlign: 'right'},
  breakdownLabel: {color: C.pine, flex: 1, fontFamily: F.m, fontSize: 10},
  ...
  breakdownShare: {color: C.muted, fontFamily: F.s, fontSize: 9, minWidth: 40, textAlign: 'right'},
  capNotice: {backgroundColor: C.amberSoft, borderRadius: 10, color: '#8a6b28', fontFamily: F.m, fontSize: 9, marginTop: 12, padding: 9},
  noteContent: {color: C.muted, fontFamily: F.r, fontSize: 9, lineHeight: 14, marginTop: 3},
  noteMeta: {color: '#a3aa9e', fontFamily: F.r, fontSize: 8, marginTop: 6},
  ...
  noteTitle: {color: C.pine, fontFamily: F.s, fontSize: 11},
  ...
  summary: {color: C.pine2, fontFamily: F.m, fontSize: 11, marginTop: 8},
});
