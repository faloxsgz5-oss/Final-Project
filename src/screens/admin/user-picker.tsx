...
const local = StyleSheet.create({
  ...
  disabledTag: {color: C.red, fontFamily: F.b, fontSize: 8},
  footer: {flexDirection: 'row', gap: 8, marginTop: 12},
  hint: {color: C.muted, fontFamily: F.r, fontSize: 10, paddingVertical: 12, textAlign: 'center'},
  ...
  selectedMeta: {color: C.muted, fontFamily: F.r, fontSize: 9, marginTop: 1},
  selectedName: {color: C.pine, fontFamily: F.b, fontSize: 12},
  subtitle: {color: C.muted, fontFamily: F.r, fontSize: 9, marginTop: 4},
  userMeta: {color: C.muted, fontFamily: F.r, fontSize: 8, marginTop: 1},
  userName: {color: C.pine, fontFamily: F.s, fontSize: 10},
