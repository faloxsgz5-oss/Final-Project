...
export default function DashboardScreen({onNavigate, uid}: Props) {
  ...
  const pending = activities.filter((item) => item.status !== 'completed');
  ...
  const urgent = pending.slice(0, 2);
...
const styles = StyleSheet.create({
  ...
  aiCard: {...shadow, backgroundColor: '#88a188', borderRadius: 18, marginBottom: 15, minHeight: 142, overflow: 'hidden', padding: 16}, aiHeading: {alignItems: 'center', flexDirection: 'row', gap: 10}, aiTitle: {color: '#fff', fontFamily: font.bold, fontSize: 17}, aiTop: {alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between'}, avatar: {...shadow, alignItems: 'center', backgroundColor: '#834b51', borderColor: '#fff', borderRadius: 25, borderWidth: 2, height: 50, justifyContent: 'center', overflow: 'hidden', width: 50}, avatarGlow: {backgroundColor: '#d8b3a5', borderRadius: 22, height: 32, opacity: .34, position: 'absolute', right: -8, top: -6, width: 32}, avatarText: {color: '#fff', fontFamily: font.bold, fontSize: 15}, bell: {...shadow, alignItems: 'center', backgroundColor: '#fff', borderRadius: 25, height: 50, justifyContent: 'center', width: 50}, budgetLine: {alignItems: 'baseline', flexDirection: 'row', marginTop: 11}, budgetUnit: {color: colors.muted, fontFamily: font.regular, fontSize: 10, marginLeft: 4}, budgetValue: {color: colors.pine, fontFamily: font.extra, fontSize: 24}, classBorder: {borderTopColor: 'rgba(44,52,27,.08)', borderTopWidth: 1}, classRow: {alignItems: 'center', flexDirection: 'row', minHeight: 70, paddingHorizontal: 13}, classTime: {color: colors.sageDark, fontFamily: font.bold, fontSize: 11}, collapsed: {alignItems: 'center', backgroundColor: '#eef2e9', borderRadius: 11, flexDirection: 'row', gap: 8, marginTop: 10, paddingHorizontal: 11, paddingVertical: 9}, collapsedText: {color: '#7b8476', flex: 1, fontFamily: font.regular, fontSize: 9, lineHeight: 14}, content: {padding: 22, paddingBottom: 28}, courseCopy: {flex: 1}, courseLine: {borderRadius: 3, height: 38, marginHorizontal: 11, width: 4}, courseTitle: {color: colors.pine, fontFamily: font.semibold, fontSize: 13}, dynamicBadge: {backgroundColor: '#e8f0e4', borderRadius: 99, paddingHorizontal: 9, paddingVertical: 5}, dynamicText: {color: colors.sageDark, fontFamily: font.semibold, fontSize: 8}, empty: {alignItems: 'center', gap: 8, paddingVertical: 22}, emptyText: {color: colors.muted, fontFamily: font.regular, fontSize: 11}, focusCard: {...shadow, backgroundColor: '#fff', borderRadius: 17, flex: 1, minHeight: 154, padding: 13}, focusGrid: {flexDirection: 'row', gap: 11, marginBottom: 15, marginTop: 11}, hello: {color: '#8a9282', fontFamily: font.regular, fontSize: 12}, loading: {alignItems: 'center', gap: 12, paddingVertical: 100}, mic: {alignItems: 'center', backgroundColor: 'rgba(255,255,255,.95)', borderColor: 'rgba(255,255,255,.55)', borderRadius: 22, borderWidth: 5, height: 44, justifyContent: 'center', width: 44}, muted: {color: colors.muted, fontFamily: font.regular, fontSize: 11}, name: {color: colors.pine, fontFamily: font.extra, fontSize: 19, marginTop: -1}, noteEyebrow: {color: colors.note, fontFamily: font.semibold, fontSize: 9}, noteIcon: {alignItems: 'center', backgroundColor: colors.noteSoft, borderRadius: 12, height: 39, justifyContent: 'center', width: 39}, noteLink: {...shadow, alignItems: 'center', backgroundColor: '#fff', borderRadius: 17, flexDirection: 'row', gap: 11, marginBottom: 4, padding: 13}, noteTitle: {color: colors.pine, fontFamily: font.semibold, fontSize: 12, marginTop: 1}, panelEmpty: {color: colors.muted, fontFamily: font.regular, fontSize: 10, marginTop: 16}, panelHeading: {alignItems: 'center', flexDirection: 'row', gap: 6}, panelTitle: {color: colors.pine, fontFamily: font.bold, fontSize: 11}, pressed: {opacity: .85, transform: [{scale: .985}]}, priorityCaption: {color: colors.muted, fontFamily: font.regular, fontSize: 9, marginBottom: 8, marginTop: 3}, priorityCard: {...shadow, backgroundColor: '#fff', borderRadius: 18, marginBottom: 15, padding: 14}, priorityCopy: {flex: 1}, priorityHeader: {alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between'}, priorityItem: {alignItems: 'center', backgroundColor: '#f6f8f3', borderColor: 'rgba(44,52,27,.06)', borderRadius: 12, borderWidth: 1, flexDirection: 'row', gap: 9, marginTop: 7, padding: 9}, priorityItemSub: {color: colors.muted, fontFamily: font.regular, fontSize: 9, marginTop: 1}, priorityItemTitle: {color: colors.pine, fontFamily: font.semibold, fontSize: 11}, priorityTitle: {color: colors.pine, fontFamily: font.bold, fontSize: 14}, priorityTitleRow: {alignItems: 'center', flexDirection: 'row', gap: 7}, progress: {backgroundColor: '#e6e6ec', borderRadius: 99, height: 6, marginTop: 9, overflow: 'hidden'}, progressFill: {backgroundColor: colors.finance, borderRadius: 99, height: 6}, profileRow: {alignItems: 'center', flexDirection: 'row', gap: 12}, prompt: {alignItems: 'center', backgroundColor: 'rgba(72,105,72,.24)', borderColor: 'rgba(44,52,27,.08)', borderRadius: 14, borderWidth: 1, flexDirection: 'row', height: 41, justifyContent: 'space-between', marginTop: 10, paddingHorizontal: 13}, promptText: {color: '#fff', flex: 1, fontFamily: font.regular, fontSize: 12}, quickAnswer: {alignItems: 'center', backgroundColor: 'rgba(255,255,255,.45)', borderRadius: 11, flexDirection: 'row', justifyContent: 'space-between', marginTop: 7, paddingHorizontal: 11, paddingVertical: 7}, quickQuestion: {color: colors.pine, fontFamily: font.regular, fontSize: 9}, quickValue: {color: colors.pine, fontFamily: font.bold, fontSize: 9}, rank: {alignItems: 'center', backgroundColor: colors.pine, borderRadius: 9, height: 26, justifyContent: 'center', width: 26}, rankSoft: {backgroundColor: colors.sage}, rankText: {color: '#fff', fontFamily: font.bold, fontSize: 10}, roomRow: {alignItems: 'center', flexDirection: 'row', marginTop: 3}, roomText: {color: '#899284', fontFamily: font.regular, fontSize: 9}, safe: {backgroundColor: '#eef1e9', flex: 1}, scheduleCard: {...shadow, backgroundColor: '#fff', borderRadius: 18, marginBottom: 16, overflow: 'hidden'}, screen: {backgroundColor: colors.mist, flex: 1}, sectionHeading: {alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10}, sectionTitle: {color: colors.pine, fontFamily: font.bold, fontSize: 15}, seeAll: {color: colors.sageDark, fontFamily: font.semibold, fontSize: 10}, statCard: {...shadow, alignItems: 'center', backgroundColor: '#fff', borderRadius: 17, flex: 1, height: 101, justifyContent: 'center'}, statIcon: {alignItems: 'center', borderRadius: 17, height: 34, justifyContent: 'center', width: 34}, statLabel: {color: colors.muted, fontFamily: font.regular, fontSize: 9, marginTop: 1, textAlign: 'center'}, statValue: {color: colors.pine, fontFamily: font.extra, fontSize: 19, marginTop: 4}, stats: {flexDirection: 'row', gap: 10, marginBottom: 17}, tag: {backgroundColor: colors.financeSoft, borderRadius: 99, maxWidth: '100%', paddingHorizontal: 7, paddingVertical: 3}, tagText: {color: '#73799f', fontFamily: font.medium, fontSize: 7}, tagWrap: {flexDirection: 'row', flexWrap: 'wrap', gap: 4, marginTop: 9}, taskCheck: {alignItems: 'center', backgroundColor: colors.note, borderRadius: 7, height: 20, justifyContent: 'center', width: 20}, taskRow: {alignItems: 'center', flexDirection: 'row', gap: 7, marginTop: 11}, taskTime: {color: colors.muted, fontFamily: font.regular, fontSize: 8}, taskTitle: {color: colors.pine, fontFamily: font.semibold, fontSize: 9}, timePill: {alignItems: 'center', backgroundColor: '#edf3ea', borderRadius: 10, minWidth: 48, paddingHorizontal: 7, paddingVertical: 6}, topRow: {alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', marginBottom: 15}, unread: {alignItems: 'center', backgroundColor: '#f35659', borderColor: '#fff', borderRadius: 8, borderWidth: 2, height: 16, justifyContent: 'center', position: 'absolute', right: 4, top: 4, minWidth: 16}, unreadText: {color: '#fff', fontFamily: font.bold, fontSize: 7}, urgency: {backgroundColor: '#fff', borderRadius: 99, paddingHorizontal: 8, paddingVertical: 4}, urgencyText: {color: colors.note, fontFamily: font.semibold, fontSize: 8},
});
