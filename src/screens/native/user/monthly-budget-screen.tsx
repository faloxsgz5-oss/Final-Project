...
const styles = StyleSheet.create({
  ...
  formSuccessBox: {alignItems: 'center', backgroundColor: C.sageSoft, borderRadius: 13, flexDirection: 'row', gap: 8, marginTop: 13, padding: 11}, formSuccessText: {color: C.sage, flex: 1, fontFamily: F.m, fontSize: 10, lineHeight: 16},
  header: {alignItems: 'center', flexDirection: 'row', gap: 10}, headerCopy: {flex: 1}, headerIcon: {alignItems: 'center', backgroundColor: C.accent, borderRadius: 21, height: 42, justifyContent: 'center', width: 42}, hero: {...shadow, borderRadius: 23, marginTop: 16, overflow: 'hidden', padding: 18}, heroAmount: {color: '#fff', fontFamily: F.x, fontSize: 32, marginTop: 2}, heroEyebrow: {color: 'rgba(255,255,255,.8)', fontFamily: F.s, fontSize: 10}, heroGlow: {backgroundColor: 'rgba(255,255,255,.15)', borderBottomLeftRadius: 90, height: 110, position: 'absolute', right: 0, top: 0, width: 110}, heroStat: {flex: 1}, heroStatLabel: {color: 'rgba(255,255,255,.7)', fontFamily: F.r, fontSize: 8}, heroStatRow: {borderTopColor: 'rgba(255,255,255,.22)', borderTopWidth: 1, flexDirection: 'row', gap: 18, marginTop: 14, paddingTop: 11}, heroStatValue: {color: '#fff', fontFamily: F.b, fontSize: 12, marginTop: 1}, heroText: {color: 'rgba(255,255,255,.82)', fontFamily: F.r, fontSize: 10}, inputHint: {color: C.muted, fontFamily: F.r, fontSize: 9, lineHeight: 15, marginTop: 7}, inputShell: {alignItems: 'center', backgroundColor: '#f6f8f4', borderColor: C.line, borderRadius: 15, borderWidth: 1, flexDirection: 'row', marginTop: 8, paddingHorizontal: 14}, loading: {alignItems: 'center', gap: 9, paddingVertical: 100}, loadingText: {color: C.muted, fontFamily: F.r, fontSize: 10}, modeBar: {backgroundColor: '#fff', borderRadius: 17, flexDirection: 'row', marginTop: 14, padding: 5}, modeButton: {alignItems: 'center', borderRadius: 13, flex: 1, flexDirection: 'row', gap: 7, justifyContent: 'center', minHeight: 43}, modeButtonActive: {backgroundColor: C.ink}, modeText: {color: C.muted, fontFamily: F.b, fontSize: 10}, modeTextActive: {color: '#fff'},
  noticeBanner: {alignItems: 'flex-start', backgroundColor: C.amberSoft, borderRadius: 16, flexDirection: 'row', gap: 9, marginTop: 14, padding: 13}, noticeText: {color: '#8a6a3c', fontFamily: F.r, fontSize: 9, lineHeight: 15, marginTop: 2}, noticeTitle: {color: C.amber, fontFamily: F.b, fontSize: 11},
  progressFill: {borderRadius: 99, height: 10}, progressLabel: {color: C.ink, fontFamily: F.b, fontSize: 11}, progressTop: {alignItems: 'baseline', flexDirection: 'row', justifyContent: 'space-between', marginBottom: 9}, progressTrack: {backgroundColor: '#e4e8e2', borderRadius: 99, height: 10, overflow: 'hidden'}, progressValue: {color: C.muted, fontFamily: F.s, fontSize: 10},
  recommendation: {alignItems: 'baseline', backgroundColor: '#f2f5ef', borderRadius: 15, flexDirection: 'row', justifyContent: 'space-between', marginTop: 15, paddingHorizontal: 13, paddingVertical: 11}, recommendationAmount: {color: C.ink, fontFamily: F.x, fontSize: 21}, recommendationLabel: {color: C.sage, fontFamily: F.b, fontSize: 10},
  retryButton: {backgroundColor: '#fff', borderRadius: 11, paddingHorizontal: 12, paddingVertical: 8}, retryText: {color: C.red, fontFamily: F.b, fontSize: 10},
  safe: {backgroundColor: C.mist, flex: 1}, save: {alignItems: 'center', borderRadius: 17, flexDirection: 'row', gap: 8, height: 54, justifyContent: 'center'}, saveShell: {...shadow, borderRadius: 17, marginTop: 15, overflow: 'hidden'}, saveText: {color: '#fff', fontFamily: F.b, fontSize: 13}, screen: {backgroundColor: C.mist, flex: 1}, split: {marginTop: 13}, splitAmount: {color: C.ink, fontFamily: F.b, fontSize: 11}, splitFill: {borderRadius: 99, height: 9}, splitLabel: {color: C.muted, fontFamily: F.s, fontSize: 10}, splitTop: {flexDirection: 'row', justifyContent: 'space-between', marginBottom: 6}, splitTrack: {backgroundColor: '#e4e8e2', borderRadius: 99, height: 9, overflow: 'hidden'},
  statusInline: {alignItems: 'center', borderRadius: 13, flexDirection: 'row', gap: 8, marginTop: 13, padding: 11}, statusInlineText: {flex: 1, fontFamily: F.b, fontSize: 11},
  title: {color: C.ink, fontFamily: F.x, fontSize: 20}, unsavedHint: {color: C.amber, fontFamily: F.m, fontSize: 9, marginTop: 9, textAlign: 'center'},
});
