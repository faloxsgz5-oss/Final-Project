...
const styles = StyleSheet.create({
  ...
  badge: {backgroundColor: '#e7efe3', borderRadius: 99, color: '#5f835f', fontFamily: 'Prompt_700Bold', fontSize: 8, overflow: 'hidden', paddingHorizontal: 7, paddingVertical: 4},
  ...
  copy: {flex: 1},
  detail: {color: '#7f8980', fontFamily: 'Prompt_400Regular', fontSize: 9, lineHeight: 14, marginTop: 2},
  eyebrow: {color: '#6f8f6d', fontFamily: 'Prompt_700Bold', fontSize: 7, letterSpacing: .7},
  ...
  reason: {color: '#889286', flex: 1, fontFamily: 'Prompt_500Medium', fontSize: 7},
  title: {color: '#2c341b', fontFamily: 'Prompt_700Bold', fontSize: 11, marginTop: 2},
});
