...
assert.equal(week.highestCategory?.category, 'Food', 'category names should be merged case-insensitively');
...
assert.equal(month.highestCategory?.category, 'Shopping');
