...
exports.extractScheduleWithOpenAI = extractScheduleWithOpenAI;
exports.SCHEDULE_EXTRACTION_SYSTEM_PROMPT = `You are a university timetable extraction engine.
...
async function extractScheduleWithOpenAI(rawText, apiKey) {
    const response = await fetch("https://api.openai.com/v1/responses", {
        ...
        body: JSON.stringify({
            ...
            store: false,
            input: [
                { role: "system", content: exports.SCHEDULE_EXTRACTION_SYSTEM_PROMPT },
    ...
    if (!text)
        throw new Error("OpenAI returned no structured schedule output.");
...
//# sourceMappingURL=openai-fallback.js.map